...
**Global conventions**
- **User-facing reports in English**; content written into artifacts (design briefs, CSV/JSON run sheets) follows the artifact's language.
...
Use when the user is planning a study and mentions any of: experiment design, control group, randomization, blocking, stratified randomization, sample size, power analysis, factorial design, DOE, response surface, crossover design, within-subject, ablation study, baseline selection, hyperparameter search, benchmark leakage, validity threats, "how many samples do I need", "how to avoid confounding", "assign subjects to groups", "is my benchmark evaluation valid".
