...
- Locate dependency manifests: `requirements*.txt`, `pyproject.toml`, `setup.py`, `environment.yml`, `Pipfile`, `Dockerfile`. Note the README's stated Python/CUDA/framework versions.
